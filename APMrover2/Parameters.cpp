...
const AP_Param::Info Rover::var_info[] = {
    ...
    // @Param: SKIP_WP_CH
    // @DisplayName: Skip WP Channel
    // @Description: The channel you pick for skipping waypoints
    // @Range: 0 10
    // @Increment: 1
    // @User: Standard
    GSCALAR(channel_skip_wp,             "SKIP_WP_CH",          8),
    ...
    // @Increment: 1
    // @User: Standard
    GSCALAR(wp_skipper_on, 		"WP_SKIPPER_ON",	0),		
    ...
    // @Param: RNGFND_WP_RAD
    // @DisplayName: Lidar Waypoint radius
    // @Description: The distance in meters from a waypoint when we will skip the wp if the lidar is triggered.
    // @Units: m
    // @Range: 0 1000
    // @Increment: 0.1
    // @User: Standard
    GSCALAR(rangefinder_wp_rad,        "RNGFND_WP_RAD",        4.0f),

    // @Param: RNGFND_SLW_RATE
    // @DisplayName: Lidar Slow Rate
    // @Description: The percentage the boat should slow down when an obstacle is being avoided.
    // @Units: m
    // @Range: 0 100
    // @Increment: 0.1
    // @User: Standard
    GSCALAR(rangefinder_thr_reduc,        "RNGFND_SLW_RATE",        50.0f),
