...
public:
    ...
    enum {
        ...
        k_param_rc_7_old,
        k_param_rc_8_old,
	k_param_channel_skip_wp,
	k_param_wp_skipper_on,
	...
	k_param_rangefinder_wp_rad,    //INDRO g.rangefinder_wp_rad
	k_param_rangefinder_thr_reduc,
        //
        // 210: driving modes
        //
    ...
    //RC Channels INDRO
    AP_Int8	channel_skip_wp;
    AP_Int8	wp_skipper_on;
    ...
    AP_Float    rangefinder_wp_rad;
    AP_Float	rangefinder_thr_reduc;
